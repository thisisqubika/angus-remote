  ...
  module Remote
    module Response
      ...
      module Builder
        ...
        #
        # @return [Class] A class client, that inherits from {Picasso::Remote::Response}
        def self.build_response_class(operation_name)
          response_class = Class.new(Picasso::Remote::RemoteResponse)
        ...
        def self.build_messages(messages)
          ...
          messages.map do |m|
            message = Picasso::Remote::Message.new
