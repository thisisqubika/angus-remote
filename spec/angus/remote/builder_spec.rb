    ...
    describe 'the returned class' do
      ...
      describe 'the generated operation' do
        ...
        describe 'the generated proxy operation' do
          before do
            Angus::Remote::ServiceDirectory.stub(service_configuration: { 'v0.1' => { 'doc_url' => 'some_url/doc',
                                                                                      'api_url' => 'some_url/api' } })
            Angus::Remote::ServiceDirectory.stub(fetch_remote_service_definition: {
                                                   'service' => { 'service' => 'vpos' },
                                                   'code_name' => 'vpos',
                                                   'version' => '0.1',
                                                   'operations' => {
                                                     'users' => {
                                                       'get_users_proxy' => { 'name' => 'Obtener usuarios' }
                                                     }
                                                   }
                                                 })
